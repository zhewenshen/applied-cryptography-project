...
HE = Pyfhel(key_gen=True, context_params={
    ...
    # Plaintext modulus (and bits). Higher t yields higher noise
    't': 65537,
...
HE = Pyfhel(key_gen=True, context_params={
    'scheme': 'CKKS',
    # For CKKS, n/2 values can be encoded in a single ciphertext.
    'n': 2**14,
...
def _r(x): return np.round(x, decimals=6)[:4]
